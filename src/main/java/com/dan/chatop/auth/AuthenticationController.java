...
public class AuthenticationController {
    ...
    @SneakyThrows
    @Operation(summary = "User Authentication, User Sign In", description = "Authenticate and return a JWT token if the user is valid.")
    ...
    public ResponseEntity<AuthenticationResponse> login(@RequestBody AuthenticationRequest request) {
        if (request.getEmail() == null || request.getPassword() == null || request.getEmail().isEmpty() || request.getPassword().isEmpty()) {
            ...
            throw new DataEntryError("Fields should not be empty!");
        }
